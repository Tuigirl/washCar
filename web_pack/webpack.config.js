...
var publicPath = '/Public/static/packaged-assets/Xiaochengxu/';      //静态资源(css,js,img) 打包路径
var assetsPath = resolve('..' + publicPath);                       //打包后的静态资源存放路径(JS,CSS,IMG...)
var htmlPath = resolve('../App/Xiaochengxu/View');                         //打包后的HTML存放路径
...
var entry = { main: __dirname + '/src/app.js' }; //主入口
var entryKeys = []

var plugins = [
  new CleanPlugin( //每次编译 自动删除之前编译完的旧文件
    ['./Public/static/packaged-assets/Xiaochengxu']
    , {
