 ...
 */
(function (d) {
    var e = 0; d.widget("ui.autocompleteuser", {
        ...
        }, _renderItem: function (a, b)
        {
            ...
            return d("<li></li>").data("item.autocomplete", b).append(d("<a><div style='height:40px;'><div style='float:left;'><img src='" + b.userhead + "' width=30 height=30 ></div><div style='float:left;padding-left:10px;'>" + b.label + " "+b.zhiwei+"<br><span class='littlegray'>" + b.company + "</span></div></div></a>")).appendTo(a);
        },
        _move: function (a, b) { if (this.menu.element.is(":visible")) if (this.menu.first() && /^previous/.test(a) || this.menu.last() && /^next/.test(a)) { this.element.val(this.term); this.menu.deactivate() } else this.menu[a](b); else this.search(null, b) },
...
(function (d) {
    var e = 0; d.widget("ui.autocomplete", {
        options: { appendTo: "body", autoFocus: false, delay: 300, minLength: 1, position: { my: "left top", at: "left bottom", collision: "none" }, source: null }, pending: 0, _create: function () {
            ...
            return d("<li></li>").data("item.autocomplete", b).append(d("<a>" + b.label +"</a>")).appendTo(a);
        },
        _move: function (a, b) { if (this.menu.element.is(":visible")) if (this.menu.first() && /^previous/.test(a) || this.menu.last() && /^next/.test(a)) { this.element.val(this.term); this.menu.deactivate() } else this.menu[a](b); else this.search(null, b) },
        widget: function () { return this.menu.element }
    }); d.extend(d.ui.autocomplete, {
