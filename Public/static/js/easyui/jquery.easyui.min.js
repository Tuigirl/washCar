...
(function($) {
    ...
    $.fn.pagination = function(_9f, _a0) {
        ...
        return this.each(function() {
            ...
            if (_a2) {
                ...
                _a1 = $.extend({},
                $.fn.pagination.defaults, $.fn.pagination.parseOptions(this), _9f);
    ...
    $.fn.pagination.defaults = {
        ...
        displayMsg: "显示 {from} 至 {to} 总数 {total} 条记录",
        nav: {
            first: {
    ...
    $.fn.tree = function(_176, _177) {
        ...
        return this.each(function() {
            ...
            if (_178) {
                ...
                opts = $.extend({},
                $.fn.tree.defaults, $.fn.tree.parseOptions(this), _176);
                $.data(this, "tree", {
                    options: opts,
                    tree: _b4(this),
                    data: []
    ...
    $.fn.tree.parseOptions = function(_192) {
        var t = $(_192);
        return $.extend({},
        $.parser.parseOptions(_192, ["url", "method", {
            checkbox: "boolean",
        ...
        return this.each(function() {
            ...
            if (_1b7) {
                ...
                _1b7 = $.data(this, "progressbar", {
                    options: $.extend({},
                    $.fn.progressbar.defaults, $.fn.progressbar.parseOptions(this), _1b4),
                    bar: init(this)
                });
            }
    ...
    $.fn.progressbar.parseOptions = function(_1bb) {
        return $.extend({},
        $.parser.parseOptions(_1bb, ["width", "height", "text", {
            value: "number"
        }]));
    };
    ...
    $.fn.tooltip = function(_1d6, _1d7) {
        ...
        return this.each(function() {
            ...
            if (_1d8) {
                ...
                $.data(this, "tooltip", {
                    options: $.extend({},
                    $.fn.tooltip.defaults, $.fn.tooltip.parseOptions(this), _1d6)
                });
                init(this);
            }
            _1bf(this);
    ...
    $.fn.tooltip.parseOptions = function(_1da) {
        var t = $(_1da);
        var opts = $.extend({},
        $.parser.parseOptions(_1da, ["position", "showEvent", "hideEvent", "content", {
            deltaX: "number",
            deltaY: "number",
            showDelay: "number",
            hideDelay: "number"
    ...
    function _1dd(_1de, _1df) {
        ...
        var _1e2 = _1e0.children("div.panel-body"),
            dH = $(window).height(), tH = 0,
            ttH = _1e2.prev().outerHeight(!0),
            mtH = _1e2.parents('.i_box').outerHeight(!0) - _1e2.parents('.i_box').innerHeight();
        ...
        if (!isNaN(opts.height)) {
            ...
            if (_1e2.hasClass('datagrid-wrap')) {
                 _1e2._outerHeight(dH - tH - ttH - mtH);
            }else {
    ...
    $.fn.panel = function(_21d, _21e) {
        ...
        return this.each(function() {
            ...
            if (_21f) {
                ...
                opts = $.extend({},
                $.fn.panel.defaults, $.fn.panel.parseOptions(this), _21d);
                $(this).attr("title", "");
    ...
    $.fn.panel.parseOptions = function(_228) {
        var t = $(_228);
        return $.extend({},
        $.parser.parseOptions(_228, ["id", "width", "height", "left", "top", "title", "iconCls", "cls", "headerCls", "bodyCls", "tools", "href", {
            cache: "boolean",
            fit: "boolean",
            border: "boolean",
            noheader: "boolean"
        ...
        return this.each(function() {
            ...
            if (_24c) {
                ...
                _24c = $.data(this, "window", {
                    options: $.extend({},
                    $.fn.window.defaults, $.fn.window.parseOptions(this), _249)
                });
    ...
    $.fn.window.parseOptions = function(_251) {
        return $.extend({},
        $.fn.panel.parseOptions(_251), $.parser.parseOptions(_251, [{
            draggable: "boolean",
            resizable: "boolean",
            shadow: "boolean",
            modal: "boolean",
    ...
    $.fn.dialog = function(_263, _264) {
        ...
        return this.each(function() {
            ...
            if (_266) {
                ...
                $.data(this, "dialog", {
                    options: $.extend({},
                    $.fn.dialog.defaults, $.fn.dialog.parseOptions(this), _263),
    ...
    $.fn.dialog.parseOptions = function(_26a) {
        return $.extend({},
        $.fn.window.parseOptions(_26a), $.parser.parseOptions(_26a, ["toolbar", "buttons"]));
    };
    ...
    $.fn.accordion = function(_2c6, _2c7) {
        ...
        return this.each(function() {
            ...
            if (_2c8) {
                ...
                $.data(this, "accordion", {
                    options: $.extend({},
                    $.fn.accordion.defaults, $.fn.accordion.parseOptions(this), _2c6),
    ...
    $.fn.accordion.parseOptions = function(_2cf) {
        var t = $(_2cf);
        return $.extend({},
        $.parser.parseOptions(_2cf, ["width", "height", {
            fit: "boolean",
            border: "boolean",
            animate: "boolean",
            multiple: "boolean",
    ...
    function _2f7(_2f8) {
        ...
        $(_2f8).children("div.tabs-header").unbind().bind("click",
        function(e) {
    ...
    $.fn.tabs = function(_336, _337) {
        ...
        return this.each(function() {
            ...
            if (_338) {
                ...
                $.data(this, "tabs", {
                    options: $.extend({},
                    $.fn.tabs.defaults, $.fn.tabs.parseOptions(this), _336),
                    tabs: [],
                    selectHis: []
                });
                _2f4(this);
    ...
    $.fn.tabs.parseOptions = function(_344) {
        return $.extend({},
        $.parser.parseOptions(_344, ["width", "height", "tools", "toolPosition", "tabPosition", {
            fit: "boolean",
            border: "boolean",
            plain: "boolean",
            headerWidth: "number",
    ...
    function _375(_376, _377, _378) {
        ...
        if (!_379[_37b]) {
            _379[_37b] = _37c(_377);
            _379[_37b].panel("panel").bind("click",
            function() {
                var _37d = _37e();
                p.panel("expand", false).panel("open").panel("resize", _37d.collapse);
                p.panel("panel").animate(_37d.expand,
                function() {
        ...
        p.panel("panel").animate(_37f.collapse, _378,
        function() {
    ...
    function _381(_382, _383) {
        ...
        if (_384[_388]) {
            ...
            p.panel("panel").animate(_386.expand,
            function() {
                _355(_382);
            });
        }
    ...
    $.fn.layout = function(_38d, _38e) {
        ...
        return this.each(function() {
            ...
            if (_38f) {
                ...
                var opts = $.extend({},
                $.fn.layout.defaults, $.fn.layout.parseOptions(this), _38d);
                $.data(this, "layout", {
                    options: opts,
                    panels: {
                        center: $(),
    ...
    $.fn.layout.parsePanelOptions = function(_396) {
        var t = $(_396);
        return $.extend({},
        $.fn.panel.parseOptions(_396), $.parser.parseOptions(_396, ["region", {
            split: "boolean",
            minWidth: "number",
            minHeight: "number",
            maxWidth: "number",
    ...
    $.fn.menu = function(_3c6, _3c7) {
        ...
        return this.each(function() {
            ...
            if (_3c8) {
                ...
                _3c8 = $.data(this, "menu", {
                    options: $.extend({},
                    $.fn.menu.defaults, $.fn.menu.parseOptions(this), _3c6)
                });
                init(this);
            }
            $(this).css({
    ...
    $.fn.menu.parseOptions = function(_3d0) {
        return $.extend({},
        $.parser.parseOptions(_3d0, ["left", "top", {
            minWidth: "number",
        ...
        return this.each(function() {
            ...
            if (_3e0) {
                ...
                $.data(this, "menubutton", {
                    options: $.extend({},
                    $.fn.menubutton.defaults, $.fn.menubutton.parseOptions(this), _3dd)
                });
                $(this).removeAttr("disabled");
            }
            init(this);
    ...
    $.fn.menubutton.parseOptions = function(_3e3) {
        var t = $(_3e3);
        return $.extend({},
        $.fn.linkbutton.parseOptions(_3e3), $.parser.parseOptions(_3e3, ["menu", {
            plain: "boolean",
            duration: "number"
        }]));
    };
        ...
        return this.each(function() {
            ...
            if (_3e8) {
                ...
                $.data(this, "splitbutton", {
                    options: $.extend({},
                    $.fn.splitbutton.defaults, $.fn.splitbutton.parseOptions(this), _3e5)
                });
                $(this).removeAttr("disabled");
            }
            init(this);
    ...
    $.fn.splitbutton.parseOptions = function(_3eb) {
        var t = $(_3eb);
        return $.extend({},
        $.fn.linkbutton.parseOptions(_3eb), $.parser.parseOptions(_3eb, ["menu", {
            plain: "boolean",
            duration: "number"
        }]));
    };
    ...
    function _3f9(_3fa) {
        ...
        _3fc.unbind(".searchbox").bind("blur.searchbox",
        function(e) {
            opts.value = $(this).val();
            if (opts.value == "") {
        ...
        _3fd.unbind(".searchbox").bind("click.searchbox",
        function() {
            opts.searcher.call(_3fa, opts.value, _3fc._propAttr("name"));
        ...
        return this.each(function() {
            ...
            if (_404) {
                ...
                _404 = $.data(this, "searchbox", {
                    options: $.extend({},
                    $.fn.searchbox.defaults, $.fn.searchbox.parseOptions(this), _402),
                    searchbox: init(this)
                });
            }
            _3f4(this);
    ...
    $.fn.searchbox.parseOptions = function(_407) {
        var t = $(_407);
        return $.extend({},
        $.parser.parseOptions(_407, ["width", "height", "prompt", "menu"]), {
            value: t.val(),
        ...
        return this.each(function() {
            ...
            if (_428) {
                ...
                $.data(this, "validatebox", {
                    options: $.extend({},
                    $.fn.validatebox.defaults, $.fn.validatebox.parseOptions(this), _426)
                });
            }
            _423(this);
            _419(this);
    ...
    $.fn.validatebox.parseOptions = function(_429) {
        var t = $(_429);
        return $.extend({},
        $.parser.parseOptions(_429, ["validType", "missingMessage", "invalidMessage", "tipPosition", {
            delay: "number",
            deltaX: "number"
        }]), {
    ...
    function _463(_464) {
        ...
        $(_464).unbind(".numberbox").bind("keypress.numberbox",
        function(e) {
        ...
        return this.each(function() {
            ...
            if (_46d) {
                ...
                _46d = $.data(this, "numberbox", {
                    options: $.extend({},
                    $.fn.numberbox.defaults, $.fn.numberbox.parseOptions(this), _46a),
                    field: init(this)
                });
                $(this).removeAttr("disabled");
                $(this).css({
    ...
    $.fn.numberbox.parseOptions = function(_470) {
        var t = $(_470);
        return $.extend({},
        $.fn.validatebox.parseOptions(_470), $.parser.parseOptions(_470, ["decimalSeparator", "groupSeparator", "suffix", {
            min: "number",
            max: "number",
            precision: "number"
        }]), {
        ...
        return this.each(function() {
            ...
            if (_498) {
                ...
                _498 = $.data(this, "calendar", {
                    options: $.extend({},
                    $.fn.calendar.defaults, $.fn.calendar.parseOptions(this), _496)
                });
                init(this);
            }
    ...
    $.fn.calendar.parseOptions = function(_499) {
        var t = $(_499);
        return $.extend({},
        $.parser.parseOptions(_499, ["width", "height", {
            firstDay: "number",
            fit: "boolean",
            border: "boolean"
        }]));
        ...
        return this.each(function() {
            ...
            if (_4ab) {
                ...
                _4ab = $.data(this, "spinner", {
                    options: $.extend({},
                    $.fn.spinner.defaults, $.fn.spinner.parseOptions(this), _4a8),
                    spinner: init(this)
                });
                $(this).removeAttr("disabled");
            }
    ...
    $.fn.spinner.parseOptions = function(_4af) {
        var t = $(_4af);
        return $.extend({},
        $.fn.validatebox.parseOptions(_4af), $.parser.parseOptions(_4af, ["width", "height", "min", "max", {
            increment: "number",
            editable: "boolean"
        }]), {
            value: (t.val() || undefined),
        ...
        return this.each(function() {
            ...
            if (_4b7) {
                ...
                $.data(this, "numberspinner", {
                    options: $.extend({},
                    $.fn.numberspinner.defaults, $.fn.numberspinner.parseOptions(this), _4b4)
                });
            }
            _4b0(this);
        });
    ...
    $.fn.numberspinner.parseOptions = function(_4b9) {
        return $.extend({},
        $.fn.spinner.parseOptions(_4b9), $.fn.numberbox.parseOptions(_4b9), {});
    };
        ...
        return this.each(function() {
            ...
            if (_4d1) {
                ...
                $.data(this, "timespinner", {
                    options: $.extend({},
                    $.fn.timespinner.defaults, $.fn.timespinner.parseOptions(this), _4ce)
                });
                _4ba(this);
            }
        });
    ...
    $.fn.timespinner.parseOptions = function(_4d3) {
        return $.extend({},
        $.fn.spinner.parseOptions(_4d3), $.parser.parseOptions(_4d3, ["separator", {
            showSeconds: "boolean",
            highlight: "number"
        }]));
    };
    ...
    function _504(_505, _506) {
        ...
        function _508(_509) {
            var _50a = _509 ? 1 : 2;
            var tr = opts.finder.getTr(_505, _506, "body", _50a); (_509 ? dc.body1: dc.body2).children("table.datagrid-btable-frozen").append(tr);
        };
    };
    ...
    function _52b(_52c) {
        ...
        _52f.find("input[type=checkbox]").unbind(".datagrid").bind("click.datagrid",
        function(e) {
        ...
        _530.unbind(".datagrid").bind("click.datagrid",
        function(e) {
    ...
    function _5fc(_5fd) {
        ...
        function _605(ids, _606) {
            for (var i = 0; i < ids.length; i++) {
                ...
                if (_607 >= 0) { (_606 == "s" ? _591: _598)(_5fd, _607, true);
                }
            }
        };
        for (var i = 0; i < data.rows.length; i++) {
    ...
    function _60a(_60b, _60c) {
        ...
        0);
        function _60e() {
            var _60f = opts.loader.call(_60b, _60d,
            function(data) {
                setTimeout(function() {
    ...
    $.fn.datagrid.parseOptions = function(_685) {
        var t = $(_685);
        return $.extend({},
        $.fn.panel.parseOptions(_685), $.parser.parseOptions(_685, ["url", "toolbar", "idField", "sortName", "sortOrder", "pagePosition", "resizeHandle", {
            fitColumns: "boolean",
    ...
    $.fn.propertygrid = function(_6f6, _6f7) {
        ...
        return this.each(function() {
            ...
            if (_6f9) {
                ...
                var opts = $.extend({},
                $.fn.propertygrid.defaults, $.fn.propertygrid.parseOptions(this), _6f6);
                opts.frozenColumns = $.extend(true, [], opts.frozenColumns);
                opts.columns = $.extend(true, [], opts.columns);
    ...
    $.fn.propertygrid.parseOptions = function(_6fa) {
        return $.extend({},
        $.fn.datagrid.parseOptions(_6fa), $.parser.parseOptions(_6fa, [{
            showGroup: "boolean"
        }]));
    };
    var _6fb = $.extend({},
    ...
    function _73c(_75b, _75c, _75d, _75e, _75f) {
        ...
        var _762 = opts.loader.call(_75b, _760,
        function(data) {
    ...
    function _741(_76a, _76b) {
        ...
        function _76d(_76f) {
            ...
            if (_770 && _770.children) {
                for (var i = 0,
                len = _770.children.length; i < len; i++) {
    ...
    function _77f(_780, _781) {
        ...
        if (_782.length) {
            ...
            _73c(_780, row[opts.idField], _784, true,
            function() {
                if (cc.is(":empty")) {
                    _782.remove();
                } else {
        ...
        return this.each(function() {
            ...
            if (_7a6) {
                ...
                _7a6 = $.data(this, "treegrid", {
                    options: $.extend({},
                    $.fn.treegrid.defaults, $.fn.treegrid.parseOptions(this), _7a3),
                    data: []
                });
            }
            _723(this);
    ...
    $.fn.treegrid.parseOptions = function(_7af) {
        return $.extend({},
        $.fn.datagrid.parseOptions(_7af), $.parser.parseOptions(_7af, ["treeField", {
            animate: "boolean"
        }]));
    };
    var _7b0 = $.extend({},
        ...
        return this.each(function() {
            ...
            if (_846) {
                ...
                _846 = $.data(this, "combo", {
                    options: $.extend({},
                    $.fn.combo.defaults, $.fn.combo.parseOptions(this), _842),
                    combo: r.combo,
                    panel: r.panel,
                    previousValue: null
                });
    ...
    $.fn.combo.parseOptions = function(_84b) {
        var t = $(_84b);
        return $.extend({},
        $.fn.validatebox.parseOptions(_84b), $.parser.parseOptions(_84b, ["width", "height", "separator", {
            panelWidth: "number",
            editable: "boolean",
    ...
    function _881(_882) {
        ...
        $(_882).combo("panel").unbind().bind("mouseover",
        function(e) {
        ...
        return this.each(function() {
            ...
            if (_887) {
                ...
                _887 = $.data(this, "combobox", {
                    options: $.extend({},
                    $.fn.combobox.defaults, $.fn.combobox.parseOptions(this), _884),
                    data: []
                });
                _881(this);
    ...
    $.fn.combobox.parseOptions = function(_88e) {
        var t = $(_88e);
        return $.extend({},
        $.fn.combo.parseOptions(_88e), $.parser.parseOptions(_88e, ["valueField", "textField", "groupField", "mode", "method", "url"]));
    };
    ...
    $.fn.combotree = function(_8a6, _8a7) {
        ...
        return this.each(function() {
            ...
            if (_8a9) {
                ...
                $.data(this, "combotree", {
                    options: $.extend({},
                    $.fn.combotree.defaults, $.fn.combotree.parseOptions(this), _8a6)
                });
            }
            _89a(this);
        });
    ...
    $.fn.combotree.parseOptions = function(_8ad) {
        return $.extend({},
        $.fn.combo.parseOptions(_8ad), $.fn.tree.parseOptions(_8ad));
    };
        ...
        return this.each(function() {
            ...
            if (_8d0) {
                ...
                _8d0 = $.data(this, "combogrid", {
                    options: $.extend({},
                    $.fn.combogrid.defaults, $.fn.combogrid.parseOptions(this), _8cd)
                });
            }
            _8ae(this);
        });
    ...
    $.fn.combogrid.parseOptions = function(_8d4) {
        var t = $(_8d4);
        return $.extend({},
        $.fn.combo.parseOptions(_8d4), $.fn.datagrid.parseOptions(_8d4), $.parser.parseOptions(_8d4, ["idField", "textField", "mode"]));
    };
    ...
    function _8d5(_8d6) {
        ...
        $(_8d6).addClass("datebox-f").combo($.extend({},
        opts, {
            onShowPanel: function() {
                _8d8();
    ...
    $.fn.datebox = function(_8e8, _8e9) {
        ...
        return this.each(function() {
            ...
            if (_8eb) {
                ...
                $.data(this, "datebox", {
                    options: $.extend({},
                    $.fn.datebox.defaults, $.fn.datebox.parseOptions(this), _8e8)
                });
            }
            _8d5(this);
        });
    ...
    $.fn.datebox.parseOptions = function(_8ee) {
        return $.extend({},
        $.fn.combo.parseOptions(_8ee), $.parser.parseOptions(_8ee, ["sharedCalendar"]));
    };
        ...
        return this.each(function() {
            ...
            if (_908) {
                ...
                $.data(this, "datetimebox", {
                    options: $.extend({},
                    $.fn.datetimebox.defaults, $.fn.datetimebox.parseOptions(this), _905)
                });
            }
            _8f3(this);
        });
    ...
    $.fn.datetimebox.parseOptions = function(_90b) {
        var t = $(_90b);
        return $.extend({},
        $.fn.datebox.parseOptions(_90b), $.parser.parseOptions(_90b, ["timeSeparator", {
            showSeconds: "boolean"
        }]));
    };
    ...
    function _927(_928) {
        ...
        _92a.find("div.slider-inner").unbind(".slider").bind("mousedown.slider",
        function(e) {
            if (_929.isDragging) {
                return;
            }
        ...
        return this.each(function() {
            ...
            if (_945) {
                ...
                _945 = $.data(this, "slider", {
                    options: $.extend({},
                    $.fn.slider.defaults, $.fn.slider.parseOptions(this), _943),
                    slider: init(this)
                });
                $(this).removeAttr("disabled");
            }
    ...
    $.fn.slider.parseOptions = function(_948) {
        var t = $(_948);
        return $.extend({},
        $.parser.parseOptions(_948, ["width", "height", "mode", {
            reversed: "boolean",
            showTip: "boolean",
            min: "number",
            max: "number",
